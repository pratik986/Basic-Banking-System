...
<body>
	...
	<ul >
			...
			<div id="main">
				<div id="main2"></div>
				<h2> Mr Pratik Mali</h2>
				    <!--img id="image2" src="C:\Users\Parkash Rai\Desktop\r.jpg" align="left"-->

			    <p> I am pursuing B.E in IT from Shah And Anchor Kutchhi Engineering
College, Mumbai.I have also worked on different
programming languages such as,HTML,CSS,JavaScript, PHP ,
MYSQL ,PYTHON ,JAVA,C,C++.
...
<div class="social-menu">
  <ul>
    ...
    <li><a href=""><i class="fa fa-instagram"><img src="img/insta.png"></i></a></li>
